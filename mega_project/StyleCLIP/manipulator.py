...
class Manipulator():
    ...
    *** Attributes ***
    ...
    def __init__(
        ...
        self.W = torch.load(f'checkpoint/W{dataset_name}.pt')
        self.S = torch.load(f'checkpoint/S{dataset_name}.pt')
        self.S_mean = torch.load(f'checkpoint/S_mean{dataset_name}.pt')
        self.S_std = torch.load(f'checkpoint/S_std{dataset_name}.pt')
