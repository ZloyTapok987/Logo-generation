...
def get_random_logo_path():
    logo_id = randrange(15192)
    path_name = "/content/drive/MyDrive/diploma/LOGOS_REFORMAT/dog/lld_{}.jpg".format(logo_id)
...
if __name__ == "__main__":
    ...
    for i in range(1000):
        if i%10 == 0:
            print("PRJOECTED {}/{} images".format(i, 1000))
        imgs = []

        files = []

        for imgfile in range(3):
            filename = get_random_logo_path()
